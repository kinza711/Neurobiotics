...
const DotCanvas = () => {
  return (
    <div id='main' className="relative w-full h-screen">
      {/* Background Image */}
      <img className="w-full h-full object-cover" src="/main.jpg" alt="Business Vision" />

      {/* Centered Content */}
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center bg-transparent px-4">
        {/* Heading */}
