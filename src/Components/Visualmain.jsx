        ...
        <div className="bg-white h-auto md:h-full w-[90%] flex flex-col md:flex-row justify-center items-center">
          ...
          <div className="left w-full md:w-8/12 flex flex-col justify-left items-start relative px-4 md:px-0 mt-10 md:mt-36">
            ...
            <p className="text-lg md:text-xl text-gray-600 mt-3">
              In today’s digital age, visual design is more than just
              aesthetics. It’s about creating an <br />
              immersive experience that speaks to your audience. <br />
              At TechXicon, our visual design team crafts stunning visuals that
              not only capture attention <br /> but also tell your brand’s
              story.
            </p>
